  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <span className="relative size-8 shrink-0 cursor-pointer">
          <FiPlus className="absolute inset-0 text-primary transition-opacity group-data-[state=open]:opacity-0" />
          <FiMinus className="absolute inset-0 text-primary opacity-0 transition-opacity group-data-[state=open]:opacity-100" />
        </span>
      </AccordionPrimitive.Trigger>
