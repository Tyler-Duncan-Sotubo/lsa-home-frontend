...
import { colorSwatchMap } from "@/constants/product-colors";
import { ProductGalleryProps } from "@/types/products";
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    transition
                    hover:scale-105 hover:border-foreground
                    ${
                      selected
              ...
              return (
                <Button
                  ...
                  className={`
                    ...
                    ${
                      selected && !disabled
                        ? "border-foreground bg-primary-foreground font-semibold border-none text-white"
