...
export async function generateMetadata(): Promise<Metadata> {
  ...
  console.log("Generating 404 metadata with config:", config);
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground md:text-base">
              It may have been renamed, moved, or removed from {storeName}. Try
              searching for a product or use the links below.
            </p>
          ...
          <div className="w-full md:w-105">
            {/* Option A: your “popular links” card */}
            {/* OR Option B: product search panel (recommended) */}
            <ProductSearchPanel />
          </div>
        </div>
